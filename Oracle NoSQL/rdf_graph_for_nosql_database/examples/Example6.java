...
/**
 * Example6 describes how to execute a SPARQL ASK query over the RDF data stored
 ...
 * 
 * <p> To execute an ASK query over the RDF data in an Oracle NoSQL database, an 
 ...
 * 
 * <p> If the ASK query is executed over RDF data (triples) from a default 
 ...
 * 
 * <p> If the ASK query is executed over RDF data (triples) from a specified
 ...
 * 
 * <p> If the ASK query is executed over RDF data from several  
