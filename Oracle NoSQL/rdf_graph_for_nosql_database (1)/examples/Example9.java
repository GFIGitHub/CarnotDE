...
/**
 * Example9 describes how to execute a SPARQL query with an OPTIONAL statement 
 * over the RDF data stored in an Oracle NoSQL database.
 * 
 ...
 * 
 * <p> To execute an query over the RDF data in an Oracle NoSQL database, an 
