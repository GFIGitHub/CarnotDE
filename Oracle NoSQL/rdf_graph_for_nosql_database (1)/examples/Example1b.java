...
/**
 * Example1b describes how to add/remove a set of triples over a named graph 
 ...
 * remove(Triple) methods from the {@link OracleNamedGraphNoSql} class. An 
 * instance of the {@link OracleNamedGraphNoSql} class can be created through 
 * the constructor {@link oracle.rdf.kv.client.jena.OracleNamedGraphNoSql
 * #OracleNamedGraphNoSql(Node, OracleNoSqlConnection)}.
 * 
 * <p> Additional settings can be defined when we create a
 * {@link OracleNamedGraphNoSql} to optimize performance, such as clear 
 * repository, bulk size used when great amounts of data is uploaded, and pool 
 * size for a Oracle NoSQL pool used in query answering and data upload. For
 * details on these configurations, see {@link OracleNamedGraphNoSql} APIs.
 * 
 * <p> To execute a query to validate the RDF data manipulation, create an 
 * instance of {@link OracleModelNoSql} from the named graph. This model is
 ...
 * object. Closing a OracleNamedGraphNoSql object does not dispose its associated 
...
public class Example1b {
  ...
  public static void main(String[] args) throws Exception 
  {
    ...
    OracleGraphNoSql graph = new OracleNamedGraphNoSql(szGraphName, conn);
    graph.clearRepository(); // Clear the named graph including inferred triples
