...
/**
 * 
 * Example2 describes how to load and store a RDF data file into an Oracle NoSQL
 * database.
 * 
 ...
 * 
 * <p> Data load is done through a call to the load method from the 
 * {@link DatasetGraphNoSql} class, specifying the file name and language in 
 * which RDF data is represented i.e. RDF/XML, N-TRIPLES, NQUADS, TURTLE, etc. 
 * 
 * <p> To execute a query to validate the RDF data load, create a 
