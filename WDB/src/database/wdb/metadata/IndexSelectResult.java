...
public class IndexSelectResult {
	...
	public WDBObject[] getFilteredResults(Adapter adapter, ArrayList indexes) throws Exception
	{
		this.doDelayedAnd(adapter, indexes);
	...
	public void doDelayedAnd(Adapter adapter, ArrayList indexes) throws Exception
	{
		...
		else 
		{
			...
			if(bestIndex != null)
			{
				...
				this.filteredList = andFilteredList(adapter.getObjects(bestIndex, bestIndexKey));
